        ...
        <div class="container py-4">
            <div class="col-md-9 mr-auto ml-auto">
                ...
                <div class="card-body bg-dark card-dark">
                   ...
                   @endif
                    <h4 class="card-title h2 text-center">Editar Categoria</h4>
                    
                    <form action="{{route('category.update',$category)}}" method="POST" class="col-md-10 my-4 text-light mr-auto ml-auto">
                        @csrf
                        @method('PUT')
